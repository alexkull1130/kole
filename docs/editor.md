...
Install the repository release's `kole-language-0.10.0.vsix` using VS Code's Extensions menu, **Install from VSIX**. Reload an existing window after an update.
